...
func (hs *HTTPServer) registerRoutes() {
	...
	r.Group("/api", func(apiRoute routing.RouteRegister) {
		...
		apiRoute.Group("/dashboards", func(dashboardRoute routing.RouteRegister) {
			...
			dashboardRoute.Get("/latest-viewed", reqSignedInNoAnonymous, routing.Wrap(hs.GetLatestViewedDashboard))
			...
			dashboardRoute.Post("/uid/:uid/latest-viewed", reqSignedInNoAnonymous, authorize(ac.EvalPermission(dashboards.ActionDashboardsRead, dashUIDScope)), routing.Wrap(hs.UpdateLatestViewedDashboard))
