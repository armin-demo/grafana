...
var (
	rawSchemaPreferencesv1alpha1     = []byte(`{"DashboardHistoryPreference":{"additionalProperties":false,"properties":{"recentDashboardUIDs":{"items":{"type":"string"},"type":"array"}},"required":["recentDashboardUIDs"],"type":"object"},"NavbarPreference":{"additionalProperties":false,"properties":{"bookmarkUrls":{"items":{"type":"string"},"type":"array"}},"required":["bookmarkUrls"],"type":"object"},"Preferences":{"properties":{"spec":{"$ref":"#/components/schemas/spec"}},"required":["spec"]},"QueryHistoryPreference":{"additionalProperties":false,"properties":{"homeTab":{"description":"one of: '' | 'query' | 'starred';","type":"string"}},"type":"object"},"spec":{"additionalProperties":false,"properties":{"dashboardHistory":{"$ref":"#/components/schemas/DashboardHistoryPreference","description":"Dashboard view history preferences"},"homeDashboardUID":{"description":"UID for the home dashboard","type":"string"},"language":{"description":"Selected language","type":"string"},"navbar":{"$ref":"#/components/schemas/NavbarPreference","description":"Navigation preferences"},"queryHistory":{"$ref":"#/components/schemas/QueryHistoryPreference","description":"Explore query history preferences"},"theme":{"description":"user interface theme","type":"string"},"timezone":{"description":"The timezone selection","type":"string"},"weekStart":{"description":"day of the week (sunday, monday, etc)","type":"string"}},"type":"object"}}`)
